...
Disse 42 tests resulterede i en code coverage på 96\%. Se figur \ref{CodeCoverage} for overblik, og se bilag !!HUSK BILAGSNUMMER HER for en interaktiv navigering af code coveragen. 
