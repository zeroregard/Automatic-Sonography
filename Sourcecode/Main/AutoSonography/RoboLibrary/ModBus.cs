...
{
    // Copied from http://www.codeproject.com/Tips/16260/Modbus-TCP-class 21. ‎oktober ‎2015, ‏‎10:04:34
    ...
    public class ModBus
    {
        ...
        public static event EventHandler NoConnectionEvent;
        ...
        public ModBus(string ip, ushort port)
        {
            this.ip = ip;
            this.port = port;
            try
            ...
            {
                NoConnectionError = ex.Message;
                NoConnectionEvent?.Invoke(this, EventArgs.Empty);
            }
        }
        ...
        /// <param name="numInputs">Magnitude of data.</param>
        ...
        {
            if (tcpSynCl == null)
                throw new Exception("No connection - was the UR10 shut down?");
            if (tcpSynCl.Connected)
            {
                try
                {
