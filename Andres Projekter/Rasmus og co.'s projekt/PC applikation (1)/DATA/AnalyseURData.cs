...
{
    /// <summary>
    /// <para>AnalyseURData is a class to analyse the data provided from the server on port 30002 on the Universal Robot</para>
    /// This class analyses the data package send from the robot on port 30002.
    /// The data structure of this package is doucmented by Univsersal Robots and is based on a UR10 with software version: 3.1.18024
    /// Link to documentation: http://www.universal-robots.com/how-tos-and-faqs/how-to/ur-how-tos/remote-control-via-tcpip-16496/
    /// </summary>
    public class AnalyseURData
    {
        ...
        public void ReadURData(byte[] data)
        {
            ...
            //Console.WriteLine("Overall package size: " + numberOfBytes);

            //Console.WriteLine("Robot MessageType: " + data[4]);
            count++;
        ...
        private void RobotState(byte[] data)
        {
            while (count < numberOfBytes - 1)
            {
                ...
                //Console.WriteLine("Subpackage size: " + BitConverter.ToInt32(subPackageSizeArray, 0));
        ...
        {
            //Console.WriteLine("Package type: {0} - ROBOT MODE DATA", data[count + 1]);
            count++;
            double timeStamp = data[count + 1] * Math.Pow(2, 8 * 7) + data[count + 2] * Math.Pow(2, 8 * 6) + data[count + 3] * Math.Pow(2, 8 * 5) + data[count + 4] * Math.Pow(2, 8 * 4) + data[count + 5] * Math.Pow(2, 8 * 3) + data[count + 6] * Math.Pow(2, 8 * 2) + data[count + 7] * Math.Pow(2, 8 * 1) + data[count + 8];
            count = count + 8;
            //Console.WriteLine("Timestamp: " + timeStamp);
            //Console.WriteLine("Content: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7]);
            count = count + 7;

            //Console.WriteLine("Robot mode: " + robotModes[data[count + 1]]);
            string robotMode = robotModes[data[count + 1]];
            count++;
            //Console.WriteLine("Control mode: " + controlModes[data[count + 1]]);
            string controlMode = controlModes[data[count + 1]];
            count++;

            //Console.WriteLine("Target Speed Fraction: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Speed Scaling: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            if (OnRobotMode != null)
        ...
        {
            //Console.WriteLine("Package type: {0} - JOINT DATA", data[count + 1]);
            count++;

            for (int i = 0; i < 6; i++)
            {
                //Console.WriteLine("Actual joint position nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
                //Console.WriteLine("Target joint position nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
                //Console.WriteLine("Actual joint speed nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
                //Console.WriteLine("Actual joint current nr. {0}: [{1}] [{2}] [{3}] [{4}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
                //Console.WriteLine("Actual joint voltage nr. {0}: [{1}] [{2}] [{3}] [{4}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
                //Console.WriteLine("Joint motor temperature nr. {0}: [{1}] [{2}] [{3}] [{4}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
                //Console.WriteLine("T micro nr. {0}: [{1}] [{2}] [{3}] [{4}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
                //Console.WriteLine("Joint mode nr. {0}: {1}", i, htJointModes[data[count + 1].ToString()]);
                count++;
            }
        }
        ...
        {
            //Console.WriteLine("Package type: {0} - TOOL DATA", data[count + 1]);
            count++;

            //Console.WriteLine("Analog Input Range 2: " + data[count + 1]);
            count++;
            //Console.WriteLine("Analog Input Range 3: " + data[count + 1]);
            count++;
            //Console.WriteLine("Analog input 2: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Analog input 3: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Tool Voltage 48V: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Tool Output Voltage: " + data[count + 1]);
            count++;
            //Console.WriteLine("Tool Current: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Tool Temperature: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Tool Mode: " + htToolModes[data[count + 1]]);
        ...
        {
            //Console.WriteLine("Package type: {0} - MASTERBOARD DATA", data[count + 1]);
            count++;
            //Console.WriteLine("Digital Input Bits: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Digital Output Bits: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Analog Input Range 0: " + data[count + 1]);
            count++;
            //Console.WriteLine("Analog Input Range 1: " + data[count + 1]);
            count++;
            //Console.WriteLine("Analog Input 0: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Analog Input 1: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Analog Output Domain 0: " + data[count + 1]);
            count++;
            //Console.WriteLine("Analog Output Domain 1: " + data[count + 1]);
            count++;
            //Console.WriteLine("Analog Output 0: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Analog Output 1: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Masterboard Temperature: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Robot Voltage 48V: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Robot Current: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Master IO Current: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Safety mode: " + safetyModes[data[count + 1] - 1]);
            string safetyMode = safetyModes[data[count + 1] - 1];
            if (OnSafetyMode != null)
                OnSafetyMode(safetyMode);
            count++;
            //Console.WriteLine("In Reduced Mode: " + data[count + 1]);
            count++;
            //Console.WriteLine("Euromap67 Installed?: " + data[count + 1]);
            if (data[count + 1] == 1) // Vis Euromap67 er installeret
            {
                //Console.WriteLine("Euromap Input Bits: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
                //Console.WriteLine("Euromap Output Bits: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
                //Console.WriteLine("Euromap Voltage: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
                //Console.WriteLine("Euromap Current: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
                count = count + 4;
            }
            else
            {
            ...
            //Console.WriteLine("Used by UR software only: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
        }
        ...
        private void KinematicsInfo(byte[] data)
        {
            ...
            //Console.WriteLine("Package type: {0} - KINEMATICS INFO", data[count + 1]);
            count++;

            for (int i = 0; i < 220; i++)
            {
                //Console.Write("[{0}] ", data[count + 1]);
                count++;
            }
            //Console.WriteLine();
        }
        ...
        {
            //Console.WriteLine("Package type: {0} - CONFIGURATION DATA", data[count + 1]);
            count++;

            for (int i = 0; i < 6; i++)
            {
                //Console.WriteLine("Joint min limit nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
                //Console.WriteLine("Joint max limit nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
            }
            for (int i = 0; i < 6; i++)
            {
                //Console.WriteLine("Joint max speed nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
                //Console.WriteLine("Joint max acceleration nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
            }

            //Console.WriteLine("Joint default speed limit: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Joint default acceleration limit: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Tool default speed limit: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Tool default acceleration limit: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;
            //Console.WriteLine("Characteristic size of the tool (EqRadius): [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            count = count + 8;

            for (int i = 0; i < 6; i++)
            {
                //Console.WriteLine("DHa nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
            }
            for (int i = 0; i < 6; i++)
            {
                //Console.WriteLine("DHd nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
            }
            for (int i = 0; i < 6; i++)
            {
                //Console.WriteLine("DHalpha nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
            }
            for (int i = 0; i < 6; i++)
            {
                //Console.WriteLine("DHtheta nr. {0}: [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}] [{8}]", i, data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
                count = count + 8;
            }
            //Console.WriteLine("Masterboard version: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Controller Box Type: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Robot type: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
            //Console.WriteLine("Robot sub type: [{0}] [{1}] [{2}] [{3}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4]);
            count = count + 4;
        }
        ...
        {
            //Console.WriteLine("Package type: {0} - FORCE MODE DATA", data[count + 1]);
            count++;

            //Console.WriteLine("X: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            double xForceDouble = GetDoubleFromByteArray(data, count);
            //Console.WriteLine("X: " + xForceDouble);
            count = count + 8;

            //Console.WriteLine("Y: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            double yForceDouble = GetDoubleFromByteArray(data, count);
            //Console.WriteLine("Y: " + yForceDouble);
            count = count + 8;

            //Console.WriteLine("Z: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            double zForceDouble = GetDoubleFromByteArray(data, count);
            //Console.WriteLine("Z: " + zForceDouble);
            count = count + 8;

            //Console.WriteLine("Rx: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            double RxForceDouble = GetDoubleFromByteArray(data, count);
            //Console.WriteLine("Rx: " + RxForceDouble);
            count = count + 8;

            //Console.WriteLine("Ry: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            double RyForceDouble = GetDoubleFromByteArray(data, count);
            //Console.WriteLine("Ry: " + RyForceDouble);
            count = count + 8;

            //Console.WriteLine("Rz: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            double RzForceDouble = GetDoubleFromByteArray(data, count);
            //Console.WriteLine("Rz: " + RzForceDouble);
            count = count + 8;

            //Console.WriteLine("Robot Dexterity: [{0}] [{1}] [{2}] [{3}] [{4}] [{5}] [{6}] [{7}]", data[count + 1], data[count + 2], data[count + 3], data[count + 4], data[count + 5], data[count + 6], data[count + 7], data[count + 8]);
            double robotDexterityDouble = GetDoubleFromByteArray(data, count);
            //Console.WriteLine("Robot Dexterity: " + robotDexterityDouble);
            count = count + 8;
        }
        ...
        {
            //Console.WriteLine("Package type: {0} - ADDITIONAL INFO", data[count + 1]);
            count++;

            //Console.WriteLine("Teach Button Pressed?: {0}", data[count + 1]);
            count++;
            //Console.WriteLine("Teach Button Enabled?: {0}", data[count + 1]);
            count++;
        }
        ...
        private void CalibrationData(byte[] data)
        {
            ...
            //Console.WriteLine("Package type: {0} - CALIBRATION DATA", data[count + 1]);
            count++;
